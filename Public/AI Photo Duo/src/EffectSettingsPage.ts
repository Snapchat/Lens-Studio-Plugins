...
export class EffectSettingsPage {
    ...
    create(parent: Ui.Widget): Ui.Widget {
        ...
        const guidelinesLink = 'https://developers.snap.com/lens-studio/features/genai-suite/ai-photo-duo';
        ...
        const previewLimitBanner = this.createCalloutWidget(
            widget,
            'The full experience is not available in Lens Studio Pro. Instead of the generated image, you will see a preview. For the full experience, use the Preview Lens function.'
        );
    ...
    private createLensPlusCard(parent: Ui.Widget): Ui.Widget {
        ...
        description.text = `Lenses created with "AI Photo Duo" will be available only to Lens+ subscribers. Using "AI Photo Duo" does not automatically enroll you in Lens+ Payouts, to begin monetizing your Lenses, ${lensPlusUrlString}.`;
