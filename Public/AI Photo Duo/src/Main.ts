...
export class PreGen extends EntityGenerator {
    ...
    private name: string = "AI Photo Duo";
    ...
    static descriptor() {
        ...
        descriptor.id = "Com.Snap.AiPhotoDuo";
        descriptor.name = "AI Photo Duo";
        descriptor.description = "AI Photo Duo";
        descriptor.dependencies = [];
        descriptor.displayOrder = 19;
