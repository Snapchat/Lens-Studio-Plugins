...
# ============================================================================
# preSyncBuild.sh -- AI Portraits CDS sync build script
#
# Steps:
#   1. npm install + npm run build (compile TypeScript to dist/)
#   2. Package: create "AI Portraits/" zip structure (flattened)
#   3. Place zip in build/resources/<version>/AI Portraits.zip
#
# STAGING LAYOUT:
#   AI Portraits uses a FLATTENED single-folder layout.
...
#           module.json
#
#   Zip filename: "AI Portraits.zip"
# ============================================================================

echo "=== AI Portraits: preSyncBuild.sh starting ==="
...
# --------------------------------------------------------------------------
echo "--- Step 2: Creating AI Portraits.zip ---"
...
STAGE_DIR="${TMPDIR:-/tmp}/ai-portraits-pkg-$$"
MODULE_DIR="$STAGE_DIR/AI Portraits"
...
ZIP_DEST="$ZIP_DIR/AI Portraits.zip"
(cd "$STAGE_DIR" && zip -r "$ZIP_DEST" "AI Portraits")

echo "Created: $ZIP_DEST"

echo "=== AI Portraits: preSyncBuild.sh completed ==="
