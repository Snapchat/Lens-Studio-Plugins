...
export class GalleryItem {
    ...
    constructor(parent: Ui.Widget, id: string) {
        ...
        this.frame.objectName = 'AiPortraits_GalleryItem_' + id;
        ...
        this.loadingOverlay.objectName = 'AiPortraits_GalleryItemTrainingOverlay_' + id;
        ...
        this.border.objectName = 'AiPortraits_GalleryItemBorder_' + id;
