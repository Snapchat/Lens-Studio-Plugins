...
import {logEventFeedback, logEventImport} from "./analytics.js";
...
export class FeedbackManager {
    ...
    constructor() {
        this.defaultTexture = new Ui.Pixmap(new Editor.Path(import.meta.resolve('./Resources/star.svg')));
        this.selectedTexture = new Ui.Pixmap(new Editor.Path(import.meta.resolve('./Resources/star_s.svg')));
        this.hoveredTexture = new Ui.Pixmap(new Editor.Path(import.meta.resolve('./Resources/star_h.svg')));
    ...
    private createSubmitDialog() {
        const gui = app.findInterface(Ui.IGui) as Ui.IGui;
