...
export const PLUGIN_ID = "Com.Snap.AiVideoTransform";
...
export function logEventImport(status: string): void {
    const eventData: any = {
...
export function logEventFeedback(stars: string, reason: string): void {
    const eventData: any = {
