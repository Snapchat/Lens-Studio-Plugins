...
export class GalleryItem {
    constructor(parent, id) {
        ...
        this.importOverlay.pixmap = new Ui.Pixmap(import.meta.resolve('./Resources/grey_rectangle.svg'));
    ...
    addPreview(previewUrl) {
        ...
        downloadFile(previewUrl, (response) => {
            if (response.statusCode !== 200) {
                return;
            }
            const path = tempDir.path.appended(this.id + "_animated.webp");
