...
export class PreGen extends EntityGenerator {
    ...
    static override descriptor() {
        ...
        descriptor.id = "Com.Snap.AiClips";
        descriptor.name = "AI Clips";
        descriptor.description = "AI Clips";
        descriptor.dependencies = [];
        descriptor.displayOrder = 14;
    ...
    constructor(pluginSystem: Editor.PluginSystem, descriptor) {
