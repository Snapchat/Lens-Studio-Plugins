...
export class TextField {
    ...
    private counterLabel: Ui.Label | null = null;
    private maxSymbols: number | undefined;
    private hasSurpriseMeButton: boolean = false;
    private connections: Array<any> = [];
    private onTextChangeCallbacks: Function[] = [];
    private onSurpriseMeButtonClickCallback: Function | null = null;

    constructor(parent: Ui.Widget, text: string, placeholderText: string = "", onSurpriseMeButtonClickCallback: Function | null = null, maxSymbols?: number) {
    ...
    private truncateToMax(text: string): string {
