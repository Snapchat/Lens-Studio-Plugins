...
export function createNegativePromptPicker(scheme) {
    return new NegativePromptPicker(scheme.parent, scheme.label, scheme.importer, scheme.exporter, scheme.hint);
}
