...
export class Preview {
    ...
    create(parent) {
        ...
        this.menuWidget.setSizePolicy(Ui.SizePolicy.Policy.Fixed, Ui.SizePolicy.Policy.Expanding);
        ...
        this.rightSideWidget.setSizePolicy(Ui.SizePolicy.Policy.Expanding, Ui.SizePolicy.Policy.Expanding);
        this.rightSideWidget.setMinimumWidth(1);
    ...
    deinit() {
        if (this.previewMenu) {
            this.previewMenu.deinit();
        }
        if (this.changeGeometryMenu) {
            this.changeGeometryMenu.deinit();
        }
