...
declare namespace Editor {
    ...
    abstract class IPackageActions extends Editor.IPluginComponent {
        ...
        exportPackage(nativePackageDescriptor: Editor.Assets.NativePackageDescriptor,path: Editor.Path, visibility: Editor.Assets.ScriptTypes.Visibility, externalDependenciesToInclude? : Editor.Model.AssetImportMetadata[]): void
