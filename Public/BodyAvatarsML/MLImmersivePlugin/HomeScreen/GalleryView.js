...
export class GalleryView {
    ...
    clearView() {
        ...
        for (let i = 9; i < this.frames.length; i++) {
    ...
    createEmptyGalleryPage(parent) {
        ...
        title.text = '<center>Welcome to<br><span style="font-size: 16px; font-weight: bold; color: #FFF0B9;">Character Skin Generator</span><center>';
        title.wordWrap = true;
        ...
        guidelinesButton.onClick.connect(() => {
            Shell.openUrl('https://developers.snap.com/lens-studio/features/genai-suite/character-skin-generator', {});
        })
