        ...
        (_c = this.assetLibImporter) === null || _c === void 0 ? void 0 : _c.downloadAsset(url, fileName, (response) => {
            ...
            if (response.success && tile) {
                ...
                if (pageName === GridPages.Actions) {
                    (_c = this.preview) === null || _c === void 0 ? void 0 : _c.onAnimationSelected(response.path, "ACTIONS", tileData[tile.getId()].id);
                }
                else if (pageName === GridPages.Emotions) {
                    (_d = this.preview) === null || _d === void 0 ? void 0 : _d.onAnimationSelected(response.path, "EMOTIONS", tileData[tile.getId()].id);
                }
                else if (pageName === GridPages.MyGallery) {
                    if (tile.getType() == "text") {
                        (_e = this.preview) === null || _e === void 0 ? void 0 : _e.onAnimationSelected(response.path, "PROMPT_TEXT", tileData[tile.getId()].id);
                    }
                    else if (tile.getType() == "video") {
                        (_f = this.preview) === null || _f === void 0 ? void 0 : _f.onAnimationSelected(response.path, "PROMPT_VIDEO", tileData[tile.getId()].id);
                    }
                    else if (tile.getType() == "stitch") {
                        (_g = this.preview) === null || _g === void 0 ? void 0 : _g.onAnimationSelected(response.path, "STITCHED", tileData[tile.getId()].id);
                    }
                    else if (tile.getType() == "animation") {
                        (_h = this.preview) === null || _h === void 0 ? void 0 : _h.onAnimationSelected(response.path, "UPLOAD", tileData[tile.getId()].id);
                    }
                    else {
