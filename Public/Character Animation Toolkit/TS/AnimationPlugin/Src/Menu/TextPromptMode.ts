...
export class TextPromptMode {
    ...
    private trashCanIcon: Ui.Pixmap;
    private inactiveTrashCanIcon: Ui.Pixmap;
    private hoveredTrashCanIcon: Ui.Pixmap;
    ...
    constructor(animationLibrary: AnimationLibrary) {
        ...
        this.trashCanIcon = new Ui.Pixmap(import.meta.resolve('./Resources/trashCan.svg'));
        this.inactiveTrashCanIcon = new Ui.Pixmap(import.meta.resolve('./Resources/inactiveTrashCan.svg'));
        this.hoveredTrashCanIcon = new Ui.Pixmap(import.meta.resolve('./Resources/trashCan_h.svg'));
        this.isActive = true;
    }

    create(parent: Ui.Widget, onReturnCallback: Function, goToGalleryPage: Function): Ui.Widget {
        ...
        const contentLayout: Ui.BoxLayout = this.menuTemplate.createContentLayout();

        const textEditButtonsLayout: Ui.BoxLayout = new Ui.BoxLayout();
        ...
        surpriseMeButton.setIconWithMode(Editor.Icon.fromFile(import.meta.resolve('./Resources/surpriseMeIcon.svg')), Ui.IconMode.MonoChrome);
        ...
        generateButton.setIconWithMode(Editor.Icon.fromFile(import.meta.resolve('./Resources/generate.svg')), Ui.IconMode.MonoChrome);
        ...
        this.connections.push(generateButton.onClick.connect(() => {
            ...
            goToGalleryPage(1);
            promptToAnimation(textEdit.plainText, (response: any) => {
                if (!this.isActive) {
                    return;
                }
        ...
        const guidelinesLink = 'https://developers.snap.com/lens-studio/features/genai-suite/character-animation#text-prompt';
