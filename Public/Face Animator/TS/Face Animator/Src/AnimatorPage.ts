...
import {ColorRole, Menu} from "LensStudio:Ui";
...
export class AnimatorPage {
    ...
    private effectPreviewPage: EffectPreviewPage | undefined;
    private preview: Preview | undefined;
    private curId: string;
    private footer: Ui.Widget | undefined;
    private progressLabel: Ui.Label | undefined;
    ...
    create(parent: Ui.Widget, onReturnCallback: Function, onItemRemovedCallback: Function, updateItemDataCallback: Function): void {
    ...
    createFooter(parent: Ui.Widget): void {
        const widget = new Ui.Widget(parent);
        widget.setContentsMargins(0, 0, 0, 0);
        widget.setFixedWidth(800);
    ...
    onTrainingStarted(id: string): void {
        generateAnimator(id, (response: any) => {
