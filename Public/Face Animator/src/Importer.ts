...
export class Importer {
    ...
    private createMLFaceEffect(model: any, sceneObject: any, scriptAsset: any, selection: any) {
    ...
    private instantiateMLFaceEffect(model: any, sceneObject: any, scriptAsset: any, selection: any) {
        const scene  = model.project.scene;
    ...
    private importEffect(ccPath: any, dnnPath: string, audioPath: string) {
    ...
    importToProject(dnnPath: string, audioPath: string) {
        this.importEffect(import.meta.resolve('./Resources/FaceAnimator.lsc'), dnnPath, audioPath);
    }

    private boom(pluginSystem: any, ccPath: string, dnnPath: string, audioPath: string) {
