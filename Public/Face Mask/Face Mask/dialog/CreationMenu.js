...
export class CreationMenu {
    ...
    createMenu(parent) {
        ...
        // Prompt input
        const promptHint = Hint.createStandardHintWidget(promptContainer, 'Prompt', 'Describe the face mask you want to generate. Be specific about details, style, and appearance.');
        this.controls["prompt"] = new TextInput(promptContainer, 'Prompt', '', 'Describe the face texture...', 200, promptHint, true);
        ...
        const negativePromptHint = Hint.createStandardHintWidget(promptContainer, 'Negative Prompt', 'Specify what you don\'t want to see in the generated face mask. This helps refine the output.');
        this.controls["negativePrompt"] = new TextInput(promptContainer, 'Negative Prompt', '', 'Enter what you don\'t want...', 200, negativePromptHint);
        ...
        // Seed
        const seedHint = Hint.createStandardHintWidget(this.menu, 'Seed', 'The seed value controls randomness. Using the same seed with identical settings will produce consistent results.');
