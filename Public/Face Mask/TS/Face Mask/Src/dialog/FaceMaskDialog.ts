...
import { logEventOpen, logEventAssetImport, logEventCreateAsset, EVENT_STATUS, EVENT_CREATE_ASSET } from '../common/Analytics';
...
export class FaceMaskDialog {
    ...
    configurePromptValueChangedCallback() {
        ...
        if (promptControl) {
            promptControl.addOnValueChanged((value: any) => {
    ...
    createMainContentWidget(parent: Ui.Widget): Ui.Widget {
    ...
    createStackedContainer(parent: Ui.Widget, mainContentWidget: Ui.Widget, notificationContainerWidget: Ui.Widget): Ui.Widget {
