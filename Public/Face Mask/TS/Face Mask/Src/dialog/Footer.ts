...
export class Footer {
    ...
    private stateToButtonConfig: Record<number, () => void>;

    public footer!: Ui.Widget;
    public generateButton!: Ui.PushButton;
    public regenerateButton!: Ui.PushButton;
    public importToProjectButton!: Ui.PushButton;
    public stackedWidget!: Ui.StackedWidget;
    private creationMenuControls: Record<string, any> = {};
    ...
    init(creationMenuControls: Record<string, any>) {
    ...
    create(parent: Ui.Widget): Ui.Widget {
        ...
        this.footer.backgroundRole = Ui.ColorRole.Mid;
