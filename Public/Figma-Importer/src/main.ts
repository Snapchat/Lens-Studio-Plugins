...
export class FigmaImporter extends PanelPlugin {
    ...
    createWidget(parent: Ui.Widget) {
        try {
            ...
            const mainWidgetLayout = new Ui.BoxLayout()
            ...
            this.stackedWidget = new Ui.StackedWidget(mainWidget)
            ...
            ////version label
            const topHeaderWidget = new Ui.Widget(mainWidget)
            topHeaderWidget.setFixedHeight(this.magicNumbers.topHeaderWidget)
            const topHeaderLayout = new Ui.BoxLayout()
            ...
            const versionLabel = new Ui.Label(topHeaderWidget)
    ...
    createConfigurationPanel() {
        const configurationPanel = new Ui.Widget(this.stackedWidget)
        const configurationLayout = new Ui.BoxLayout()
        configurationLayout.setDirection(Ui.Direction.TopToBottom)
        configurationLayout.spacing = this.spacing

        //back button
        const backButton = new Ui.PushButton(configurationPanel)
        ...
        //create a dropdown
        const scalerDropdown = new Ui.ComboBox(configurationPanel)
        ...
        //create a horizontal layout
        const hLayout2 = new Ui.BoxLayout()
        ...
        //create a dropdown
        const stretchModeDropdown = new Ui.ComboBox(configurationPanel)
        //get the options from the user pref manager
        ...
        //3. save button
        const saveBtn = new Ui.PushButton(configurationPanel)
        ...
        const emptyLabelForSpacing = new Ui.Label(configurationPanel)
    ...
    createPreAuthWidget() {
        ...
        const preAuthWidget = new Ui.Widget(this.stackedWidget)
        const preAuthLayout = new Ui.BoxLayout()
    ...
    createPostAuthWidget() {
        ...
        const vsa = new Ui.VerticalScrollArea(this.stackedWidget)

        const containerWidget = new Ui.Widget(vsa)
        ...
        const configurationButton = new Ui.PushButton(containerWidget)
    ...
    createProgressBarDialog() {
        try {
            ...
            const progressBar = new Ui.ProgressBar(dialog)
