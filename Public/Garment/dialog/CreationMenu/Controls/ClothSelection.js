...
class Selector {
    constructor(parent, maxRowItems = 3) {
        ...
        this.hoverImage = new Ui.Pixmap(import.meta.resolve('../Resources/hover.svg'));
        this.defaultImage = new Ui.Pixmap(import.meta.resolve('../Resources/default.svg'));
        this.selectedImage = new Ui.Pixmap(import.meta.resolve('../Resources/selected.svg'));
    ...
    addItem(settings) {
        ...
        const garment_image = new Ui.ImageView(tile_bg);
        ...
        garment_image.pixmap = new Ui.Pixmap(import.meta.resolve('../Resources/' + settings.preview_image));

        garment_image.move(2, 3);

        const garment_label = new Ui.ClickableLabel(tile_bg);
