...
export class PreviewMenu {
    ...
    createHeadmorph(controls) {
        ...
        if (this.updateAssetOption.value == 'Change Texture') {
            ...
            }, true, this.headmorph_id);
            origin = "CHANGE_TEXTURE";
        } else {
            data = buildAssetData(controls, false, this.headmorph_id);
        ...
        createMorph(data, function(response) {
            ...
            logEventAssetCreation(status, settings, origin, data.uploadUid == null ? "PROMPT_TEXT" : "PROMPT_IMAGE");
        }.bind(this));
    }
    ...
    createHeader(parent) {
        ...
        this.headerTitle.text = `${app.name} Preview`;
