...
import {createGenerationInProgressWidget, downloadFileFromBucket, importToProject} from '../utils.js';
...
const ASSET_PREVIEW_WIDTH = 332;
const ASSET_PREVIEW_HEIGHT = 525;
...
export class AssetPreview {
    ...
    createPreview(parent) {
        ...
        this.leftArrow.setFixedWidth(36);
        this.leftArrow.setFixedHeight(36);
        ...
        this.rightArrow.setFixedWidth(36);
        this.rightArrow.setFixedHeight(36);
        ...
        previewWidget.setFixedWidth(ASSET_PREVIEW_WIDTH);
        ...
        this.splitViewer.radius = 8;

        previewWidgetLayout.addWidgetWithStretch(this.splitViewer, 0, Ui.Alignment.AlignLeft);
        ...
        // this.stackedWidget.setSizePolicy(Ui.SizePolicy.Policy.Fixed, Ui.SizePolicy.Policy.Fixed);
    ...
    setDefaultState() {
        ...
        this.splitViewer.setFixedHeight(ASSET_PREVIEW_WIDTH);
    ...
    updatePreviewImage() {
        ...
        if (!this.loadedImages[imageIndex][0]) {
            downloadFileFromBucket(this.imageLinks[imageIndex]['sourceImageUrl'],
                ...
                (filepath) => {
                    if (!this.loadedImages[imageIndex]) {
                        return;
                    }
    ...
    onImportToProject() {
        ...
        importToProject(this.objectUrl, function(success) {
            ...
            app.log(success ? `${app.name} is succesfully imported to the project` : 'Import failed, please try again');
        }.bind(this));
    }
    ...
    onCreateModel(id, postProcessingSettings) {
        ...
        createModel(id, postProcessingSettings, (response) => {
            if (response.statusCode == 201) {
                ...
                if (this.effectTypeId === 'full-frame-enhanced') {
                    this.statusLabel.text = '<div style="text-align: right;">' + 'Model training in progress. This may take 3-5 hours.<br>You can close the window and return later.' + '</div>';
}
                else {
                ...
                getModels(this.effectId, (response) => {
                    if (response[0]) {
                        ...
                        if (response[0].trainingState == 'SUCCESS') {
                            this.objectUrl = response[0].objectLsUrl;
