...
export class PromptPicker extends Control {
    ...
    ['createPromptHeaderWidget'](parent, label, hint) {
        ...
        promptHeaderWidget.setSizePolicy(Ui.SizePolicy.Policy.Expanding, Ui.SizePolicy.Policy.Fixed);
        ...
        if (hint) {
            const infoIconImage = new Ui.Pixmap(import.meta.resolve('./Resources/info.svg'));
            ...
            promptToolTip.onHover.connect((hovered) => {
                if (hovered) {
        ...
        this.surpriseMeLabel.onClick.connect(() => {
