...
import {getRandomEnhancedPrompt, getRandomInt} from "../../utils.js";
import {EnhancedPromptPicker} from "./EnhancedPromptPicker";
...
export class Seed extends Control {
    constructor(parent, label, valueImporter, valueExporter, hint) {
        super(parent, null, valueImporter, valueExporter, hint);
        this.connections = [];
...
export function createSeed(scheme) {
    return new Seed(scheme.parent, scheme.label, scheme.importer, scheme.exporter, scheme.prompt_hint);
}