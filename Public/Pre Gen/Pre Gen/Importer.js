...
export class Importer {
    ...
    createMLFaceEffect(model, sceneObject, scriptAsset, selection, packId) {
    ...
    instantiateMLFaceEffect(model, sceneObject, scriptAsset, selection, packId) {
        const scene = model.project.scene;
    ...
    importEffect(filePath, packId, previewsPath) {
    ...
    importCustomComponent(assetManager, filePath, packId, previewsPath) {
