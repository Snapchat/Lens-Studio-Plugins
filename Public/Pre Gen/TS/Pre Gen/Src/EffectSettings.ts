...
export class EffectSettings {
    ...
    previewIdxChanged(id: string, previewId: number): void {
        ...
        if (this.previews[id][previewId]) {
            ...
            this.downloadPreview(this.settings[id].previews[previewId].sourceImageUrl, id + "_" + previewId + "_sourceImage", (path: string) => {
    ...
    private downloadPreview(url: string, fileName: string,  callback: Function): void {
