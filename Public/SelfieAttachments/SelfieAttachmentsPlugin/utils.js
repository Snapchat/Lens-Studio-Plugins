...
export function createGenerationErrorWidget(parent) {
    ...
    disclaimerLabel.text = '<center>There was a problem generating the Selfie Attachments.</center><center>Please try to generate another one.</center>';
...
export function importToProject(objectUrl, callback, file_format) {
    downloadFileFromBucket(objectUrl, "Selfie Attachments Package.lspkg", function(file_path, tempDir) {
