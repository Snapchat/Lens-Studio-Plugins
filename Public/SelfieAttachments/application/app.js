...
import { SelfieAttachmentsPlugin } from '../SelfieAttachmentsPlugin/SelfieAttachments.js';
...
class Application {
    ...
    initialize(pluginSystem) {
        ...
        this.mPlugin = new SelfieAttachmentsPlugin(this.mGui.createDialog());
