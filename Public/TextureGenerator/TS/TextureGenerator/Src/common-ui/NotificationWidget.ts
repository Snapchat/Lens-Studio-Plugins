...
export class ErrorNotificationWidget extends CalloutWidget {
    constructor(parent: Ui.Widget, text: string) {
        super(
            parent,
            text,
            createColor(234, 85, 99, 255),
            new Editor.Path(import.meta.resolve('./Resources/error_icon.svg'))
        );
    }
}
