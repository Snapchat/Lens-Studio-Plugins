...
export function createColor(r: number, g: number, b: number, a: number) {
...
export function createIcon(parent: Ui.Widget, iconImage: Ui.Pixmap, size: number = Ui.Sizes.IconSide) {
