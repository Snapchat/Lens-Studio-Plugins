...
export class Preview {
    ...
    private state: number = PreviewState.HomeScreen;
    private stateToScreen: Record<number, () => void>;

    public stackedWidget!: Ui.StackedWidget;
    public widget!: Ui.Widget;
    private preview!: Ui.Widget;
    private previewImage!: Ui.ImageView;
    private homeScreen!: Ui.Widget;
    private logo!: Ui.ImageView;
    private welcomeText!: Ui.Label;
    private disclaimer!: Ui.Label;
    private ctaButton!: Ui.PushButton;
    ...
    showRunning() {
        ...
        this.disclaimer.text = '<center>Generating preview...<br> This may take up to 5 seconds.</center>';
        this.disclaimer.visible = true;
        this.ctaButton.visible = false;
    ...
    createPreview(parent: Ui.Widget): Ui.Widget {
    ...
    createGenerationErrorWidget(parent: Ui.Widget): Ui.Widget {
        ...
        disclaimerLabel.text = '<center>There was a problem generating the texture.</center><center>Please try to generate another one.</center>';
    ...
    createHomeScreen(parent: Ui.Widget): Ui.Widget {
