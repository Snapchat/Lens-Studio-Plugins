...
class GuidelineAndTermsWidget extends CalloutWidget {
    constructor(parent, text, link) {
        super(parent, text, createColor(68, 74, 85, 255), new Editor.Path(import.meta.resolve('./Resources/info.svg')));
...
export function createGuidelinesWidget(parent) {
    const guidelinesLink = 'https://developers.snap.com/lens-studio/features/genai-suite/texture';
