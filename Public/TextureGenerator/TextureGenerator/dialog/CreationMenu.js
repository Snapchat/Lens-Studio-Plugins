...
export class CreationMenu {
    ...
    createMenu(parent) {
        ...
        const negativePromptHint = Hint.createStandardHintWidget(promptContainer, 'Negative Prompt', 'Specify what you don\'t want to see in the generated texture. This helps refine the output.');
