...
export class AssetPreview {
    ...
    createPreview(parent) {
        ...
        this.interactivePreview.setSizePolicy(Ui.SizePolicy.Policy.Fixed, Ui.SizePolicy.Policy.Fixed);
        this.interactivePreview.setFixedHeight(555);
        this.interactivePreview.setFixedWidth(480);
