...
export function createAsset(data, callback) {
    const request = new Network.HttpRequest();
    request.url = 'https://ml.snap.com/api/splats';
...
export function listAssets(maxPageSize, callback, searchQuery, pageToken) {
    const request = new Network.HttpRequest();
    let url = 'https://ml.snap.com/api/splats?maxPageSize=' + maxPageSize;
...
export function getAsset(id, callback) {
    const request = new Network.HttpRequest();
    request.url = 'https://ml.snap.com/api/splats/' + id;
    request.method = Network.HttpRequest.Method.Get;
...
export function selectSplat(asset_id, data, callback) {
    const request = new Network.HttpRequest();
    request.url = 'https://ml.snap.com/api/splats/' + asset_id + ':select-object';
    request.method = Network.HttpRequest.Method.Put;
    request.body = JSON.stringify(data);
...
export function submitSplat(asset_id, callback) {
    const request = new Network.HttpRequest();
    request.url = 'https://ml.snap.com/api/splats/' + asset_id + ':submit';
    request.method = Network.HttpRequest.Method.Put;
