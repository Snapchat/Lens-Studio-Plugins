...
import { GaussianSplattingGenerationPlugin } from '../ThreeDCapture/GaussianSplattingPlugin.js';
...
class Application {
    ...
    initialize(pluginSystem) {
        ...
        this.mPlugin = new GaussianSplattingGenerationPlugin(this.mGui.createDialog());
